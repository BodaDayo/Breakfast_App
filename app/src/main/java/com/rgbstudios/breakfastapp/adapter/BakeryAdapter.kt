...
class BakeryAdapter(val options: List<FoodOption>, sharedViewModel: OrderViewModel) :
    RecyclerView.Adapter<BakeryAdapter.ViewHolder>() {
    ...
    private fun updateCart(option: FoodOption) {
        ...
        viewModel.addItemToBakeryCart(option)
    }
}