...
class DessertsAdapter(val options: List<FoodOption>, sharedViewModel: OrderViewModel) : RecyclerView.Adapter<DessertsAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = FoodOptionBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    private fun updateCart(option: FoodOption) {
        ...
        viewModel.addItemToDessertsCart(option)
    }
