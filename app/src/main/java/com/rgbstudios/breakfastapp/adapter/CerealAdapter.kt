...
class CerealAdapter(val options: List<FoodOption>, sharedViewModel: OrderViewModel) :
    RecyclerView.Adapter<CerealAdapter.ViewHolder>() {
    ...
    private fun updateCart(option: FoodOption) {
        ...
        viewModel.addItemToCerealCart(option)
    }
