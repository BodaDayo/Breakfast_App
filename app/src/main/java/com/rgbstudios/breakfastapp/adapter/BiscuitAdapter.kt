...
class BiscuitAdapter(val options: List<FoodOption>, sharedViewModel: OrderViewModel) :
    RecyclerView.Adapter<BiscuitAdapter.ViewHolder>() {
    ...
    private fun updateCart(option: FoodOption) {
        ...
        viewModel.addItemToBiscuitCart(option)
    }
